...
This can be done via the [web app ](https://app.ssv.network/)interface or through the smart contracts and developer tools (see [get started](broken-reference) guide).

#### Operators Selection <a href="#jm9n7m464k0" id="jm9n7m464k0"></a>
...
#### Operational Costs <a href="#jm9n7m464k0" id="jm9n7m464k0"></a>
...
#### Validator Funding <a href="#kumpogh364aq" id="kumpogh364aq"></a>
