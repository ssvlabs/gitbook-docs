...
2. [**Setup Sidecars**](/operators/operator-node/setup-sidecars)
...
3. [**Monitoring setup**](/operators/operator-node/monitoring)
...
4. [**Maintenance**](/operators/operator-node/maintenance)
...
After you're done with installation, you can go and [register your operator](/operators/operator-management) to the network.