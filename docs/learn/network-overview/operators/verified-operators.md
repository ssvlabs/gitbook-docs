---
description: Understanding verified operators in SSV Network
sidebar_position: 2
---
...
Verified Operators (VOs) are a DAO-curated list of operators that meet defined program requirements. In most cases, they are established teams with experience running PoS staking and blockchain infrastructure services.

SSV Network is an open protocol in which stakers can freely choose among operators. As the network grows, comparing operators becomes more difficult.
...
![](https://app.ssv.network/images/operator\_type/verified.svg)
