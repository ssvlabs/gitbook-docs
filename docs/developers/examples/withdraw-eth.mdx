...
It is advised to use the [`createClusterID`](/developers/SSV-SDK/module-reference/api-module#createclusteridowner_address-operator_ids) function to get the cluster ID in the correct format.
