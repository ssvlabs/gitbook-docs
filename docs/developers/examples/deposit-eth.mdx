...
Depositing ETH increases the cluster balance used to pay ongoing validator operating costs. This is a write operation and requires the SDK to be [initialized](/developers/SSV-SDK/#initialization) with a `walletClient`.
...
- The SDK initialized with a `walletClient`
