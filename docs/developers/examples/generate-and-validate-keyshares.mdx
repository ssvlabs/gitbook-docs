...
The shares and the signature are constructed as [**sharesData**](/learn/security/keyshares-structure.md) which is used during validator registration through the [SSV smart contract](/developers/smart-contracts/ssvnetwork) in order to facilitate their distribution from stakers to operators.
