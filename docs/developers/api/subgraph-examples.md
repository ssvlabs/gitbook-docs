...
Returns the cluster snapshot required by several smart contract functions, such as [validator registration](/developers/smart-contracts/ssvnetwork.md#bulkregistervalidatorpublickey-operatorids-shares-cluster).
...
Returns the data needed to compute the [cluster balance](/learn/network-overview/clusters/cluster-balance).
