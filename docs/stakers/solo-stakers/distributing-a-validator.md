...
You can manage your validators by following guides from the [**Cluster Management section**](/stakers/cluster-management/README.md). 

Additionally, you can offboard your validators by following guides from the [**Validator Offobarding section**](/stakers/validator-offboarding/README.md)