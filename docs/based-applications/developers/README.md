...
:::info
Before registering your Based Application, you will need to create a client and the Based Application middleware contract, [you can refer to this guide](./get-started.md) for more information on this.
:::
