...
Services that want to [integrate with SSV's Based Application framework](/based-applications/developers/) need to develop a smart contract, and register it to the [Based Application Manager contract](../smart-contracts/SSVBasedApps). To be accepted by the Based Application Manager contract, this must meet certain specifications.
